...
function AvatarUsuario({ foto, nome }) {
    ...
    const nomeSeguro = String(nome || "Cliente");
    const inicial =
        nomeSeguro.trim().charAt(0).toUpperCase() || "?";

    if (!urlFoto || fotoComErro) {
        return (
            <div
                className={styles.avatarVazio}
                aria-hidden="true"
            >
                {inicial}
            </div>
    ...
    return (
        <section className={styles.carrossel}>
            ...
            <div className={styles.header}>
                ...
                <p>
                    Avaliações reais de quem escolheu a Pixel Color
                    para transformar ambientes com mais personalidade,
                    qualidade e cor.
                </p>
            </div>
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className={styles.cartaoTopo}>
                                                ...
                                                <span className={styles.numeroDecorativo}>
                                                    0
                                                    {(
                                                        indiceAtual +
                                                        1
